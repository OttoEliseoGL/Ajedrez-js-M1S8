...
//Referencia al Texto de Búsqueda
const textoBusqueda = document.getElementById("textoBusqueda");
//Referencia al Párrafo del Resultado
...
function buscar() {
    ...
    if (termino_busqueda == "") {
        ...
        console.log("Entró a la función buscar");
        console.log("El usuario está buscando: ", termino_busqueda);
